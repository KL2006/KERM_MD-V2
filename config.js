...
global.owner = process.env.OWNER_NUMBER || "+1 (849)8651198";
...
module.exports = {
  ...
  author: process.env.PACK_AUTHER |shadow| "KG TECH",
  packname: process.env.PACK_NAME |shadow 1| "Kerm-MD-V2",
  botname: process.env.BOT_NAME |baki| "*ᵏᵍ┘𝙺𝙴𝚁𖤐*",
  ownername: process.env.OWNER_NAME |shadow| "☞⌜ KG TECH⌝☜",
